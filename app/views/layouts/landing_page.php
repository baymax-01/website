        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            <div class="feature-item">
              <i class="fe fe-calendar tex-red"></i>
          ...
          <div class="col-lg-4">
            <div class="feature-item">
              <i class="fe fe-phone-call tex-red"></i>
              <h3><?=lang("Supports")?></h3>
          ...
          <div class="col-lg-4">
            <div class="feature-item">
              <i class="fe fe-upload-cloud tex-red"></i>
              <h3><?=lang("Updates")?></h3>
          ...
          <div class="col-lg-4">
            <div class="feature-item">
              <i class="fe fe-share-2 tex-red"></i>
          ...
          <div class="col-lg-4">
            <div class="feature-item">
              <i class="fe fe-dollar-sign tex-red"></i>
