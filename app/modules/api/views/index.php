  ...
  <div class="col-md-8 mb-3">
    <div class="white_card">
      <div class="white_card_header">
        <h3 class="white_card_title"><?= lang("api_documentation") ?></h3>
        
      </div>
      <div class="white_card_body collapse show">
        <div class="x_content">
    ...
    <div class="white_card">
      ...
      <div class="white_card_body">
        <div class="form-group x_content">
          ...
          <!-- Default -->
          <table class="table table-hover service-default">
            <thead>
              <tr>
          ...
          <!-- package -->
          <table class="table table-hover service-package d-none">
            <thead>
              <tr>
                <th><?= lang("parameter") ?></th>
                <th><?= lang("Description") ?></th>
          ...
          <!-- Custom Comments -->
          <table class="table table-hover service-custom-comments d-none">
            <thead>
              <tr>
                <th><?= lang("parameter") ?></th>
                <th><?= lang("Description") ?></th>
          ...
          <table class="table table-hover service-mentions-with-hashtags d-none">
            <thead>
              <tr>
                <th><?= lang("parameter") ?></th>
                <th><?= lang("Description") ?></th>
          ...
          <table class="table table-hover service-mentions-custom-list d-none">
            <thead>
              <tr>
                <th><?= lang("parameter") ?></th>
                <th><?= lang("Description") ?></th>
          ...
          <!-- mentions-hashtag -->
          <table class="table table-hover service-mentions-hashtag d-none">
            <thead>
              <tr>
                <th><?= lang("parameter") ?></th>
                <th><?= lang("Description") ?></th>
          ...
          <table class="table table-hover service-mentions-user-followers d-none">
            <thead>
              <tr>
                <th><?= lang("parameter") ?></th>
                <th><?= lang("Description") ?></th>
          ...
          <table class="table table-hover service-custom-comments-package d-none">
            <thead>
              <tr>
                <th><?= lang("parameter") ?></th>
                <th><?= lang("Description") ?></th>
          ...
          <table class="table table-hover service-mentions-media-likers d-none">
            <thead>
              <tr>
                <th><?= lang("parameter") ?></th>
                <th><?= lang("Description") ?></th>
          ...
          <!-- comment-likes -->
          <table class="table table-hover service-comment-likes d-none">
            <thead>
              <tr>
                <th><?= lang("parameter") ?></th>
                <th><?= lang("Description") ?></th>
          ...
          <!-- Subscriptions -->
          <table class="table table-hover service-subscriptions d-none">
            <thead>
              <tr>
                <th><?= lang("parameter") ?></th>
                <th><?= lang("Description") ?></th>
