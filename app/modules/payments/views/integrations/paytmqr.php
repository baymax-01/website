            ...
            <div class="form-body">
              <div class="row justify-content-md-center">
                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    <label class="form-label">PaytmQR MID (Merchant ID)<span class="form-required">*</span></label>
                    <input type="text" class="form-control" name="payment_params[option][paytmqr_mid]" value="<?php echo (isset($option->paytmqr_mid)) ? $option->paytmqr_mid : ''; ?>">
                  </div>
