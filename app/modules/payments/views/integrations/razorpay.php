            ...
            <div class="form-body">
              <div class="row justify-content-md-center">
                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    <label class="form-label">Razropay Public Key<span class="form-required">*</span></label>
                  ...
                  <div class="form-group">
                    <label class="form-label">Razropay Secret Key<span class="form-required">*</span></label>
