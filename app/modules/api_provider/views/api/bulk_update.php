              ...
              <div class="row justify-content-md-center">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="form-group">
                    ...
                    <select name="refill" class="form-control square">
                      <option value="0" <?php if(!empty($api->refill) || $api->refill == "0") { echo "selected"; }?>><?=$i?>Deactive</option>
                      <option value="1" <?php if(!empty($api->refill) || $api->refill == "1") { echo "selected"; }?>><?=$i?>Active</option>
                    </select>
                  </div>
                </div>
