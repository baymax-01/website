            ...
            <div class="row">
              ...
              <div class="col-md-6 col-sm-6 col-xs-6">
                <div class="form-group">
                  ...
                  <small class="tex-red"><?=lang("note_if_you_dont_want_to_change_password_then_leave_these_password_fields_empty")?></small>
                </div>
              </div> 
              ...
              <div class="col-md-12 col-sm-12 col-xs-12 form-actions">
                <div class="p-l-10">
                  <button type="submit" class="btn_2 mt-1 mb-1 w-100"><?=lang('Save')?></button>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              ...
              <div class="col-md-6 col-sm-6 col-xs-6">
                <div class="form-group">
                  ...
                  <small class="tex-red"><?=lang("note_if_you_dont_want_add_more_information_then_leave_these_informations_fields_empty")?></small>
                </div>
              </div>
    ...
    <div class="white_card">
      ...
      <div class="white_card_body">
        <form class="form actionForm" action="<?=cn($module."/ajax_update_api")?>" data-redirect="<?=cn($module)?>" method="POST">
          ...
          <div class="">
            <button type="submit" class="btn_2 mt-1 mb-1 w-100"><?=lang("Generate_new")?></button>
          </div>
        </form>
      </div>
    </div>
