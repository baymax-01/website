<div class="row justify-content-md-center justify-content-xl-center m-t-30" id="result_ajaxSearch" >
  <div class="col-md-10 col-xl-10 " >
      ...
      <div class="alert alert-success" role="alert">
          ...
          <ul>
              <li>Order id : <?=$order_success->id?></li>
              <li>Name : <?=$order_success->name?></li>
              <li>Charge : <?=$order_success->charge?></li>
              <li>Quantity : <?=$order_success->quantity?></li>
              <li>Link : <?=$order_success->link?></li>
              <li>Remaining Balnace : <?=$balance = get_field(USERS, ["id" => session('uid')], 'balance');?></li>
          </ul>
      </div>
      <?php }?>         
              ...
              <div class="row">
                <div class="col-md-6 mb-3">
                  ...
                  <div class="form-group" id="result_total_charge">
                    ...
                    <p class="btn btn_1 total_charge"><?=lang("total_charge")?> <span class="charge_number">$0</span></p>
