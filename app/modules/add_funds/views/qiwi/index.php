    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="for-group text-center">
          <img src="<?=BASE?>/assets/images/payments/qiwi.png" alt="Qiwi icon">
          <p class="p-t-10"><small><?=sprintf(lang("you_can_deposit_funds_with_paypal_they_will_be_automaticly_added_into_your_account"), 'Qiwi')?></small></p>
        </div>
        ...
        <div class="form-group">
          ...
          <ul>
            ...
            ?>
            <li><?=lang("currency_rate")?>: 1RUB = <strong><?php echo $currency_rate_to_usd; ?></strong>USD</li>
            <?php }?>
