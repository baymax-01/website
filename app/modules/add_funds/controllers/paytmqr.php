...
class paytmqr extends MX_Controller
{
	...
	public function __construct($payment = "")
	{
		...
		// Payment Option
		$this->paytmqr_mid        = get_value($option, 'paytmqr_mid');
	...
	{
		$requestParamList = array("MID" => $this->paytmqr_mid, "ORDERID" => session('qrtransaction_id'));

		$responseParamList = array();

		$responseParamList = getTxnStatusNew($requestParamList);

		// if ($this->paytmqr_mid != $responseParamList["MID"]) {
