    ...
    <div class="col-md-12">
      <h1 class="page-title">
        <span data-toggle="modal" data-target="#install-module">
          <span class="add-new" data-toggle="tooltip" data-placement="bottom" title="<?=lang("add_new")?>" data-original-title="Add new"><i class="fa fa-plus-square tex-red" aria-hidden="true"></i>
          </span>
        </span> 
        <?=lang("Modules")?>
      </h1>
