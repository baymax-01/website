  ...
  <div class="container h-100">
    <div class="row h-100 align-items-center auth-form">
      <div class="col-md-6 col-login mx-auto ">
        <form class="white_card actionForm" action="<?= cn("auth/ajax_sign_in") ?>" data-redirect="<?= cn('statistics') ?>" method="POST">
          <div class="white_card_body ">
            ...
            <div class="form-footer">
              <button type="submit" class="btn_2 mt-1 mb-1 w-100"><?= lang("Login") ?></button>
            </div>
